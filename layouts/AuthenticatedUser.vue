    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center justify-between h-12 md:h-16">
        <div class="flex items-center">
          ...
          <span class="text-tm-green hidden sm:block">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="64"
              height="64"
        ...
        <div class="flex items-center">
          <NuxtLink to="/profiles/user-posts">
            <img
              ...
              class="rounded-full w-9 md:w-12 border border-tm-gray ring-2 ring-white"
              alt="Avatar"
            >
          </NuxtLink>
        </div>
        ...
        <div class="grid grid-cols-12">
          ...
          >
            <div class="bg-white rounded-3xl py-2">
              ...
              <div class="my-10">
                <NuxtLink to="/town-notifications">
                  <span v-if="$route.path == '/town-notifications'">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                  ...
                  <h4 v-if="$route.path == '/town-notifications'" class="text-lg font-medium leading-tight my-2 text-tm-green">
                    Notifications
                  </h4>
                  <h4 v-else class="text-lg font-medium leading-tight my-2">
                    Notifications
      ...
      <div class="md:hidden block fixed inset-x-0 bottom-0 z-10 bg-tm-green p-2 m-2 rounded-3xl shadow">
        <div class="flex items-center justify-around text-white text-sm">
          ...
          <NuxtLink to="/town-notifications">
            <span>
              <svg
                v-if="$route.path == '/town-notifications'"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                fill="currentColor"
              ...
              <span v-if="$route.path == '/town-notifications'" class="font-bold">Notifications</span>
