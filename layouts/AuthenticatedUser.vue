      ...
      <div class="flex items-center justify-between h-12 md:h-16">
        ...
        <div class="flex items-center">
          ...
          <img
            ...
            class="rounded-full w-9 md:w-12 border border-tm-gray ml-4"
            alt="Avatar"
          >
        </div>
      </div>
        ...
        <div class="grid grid-cols-12">
          ...
          >
            <div class="bg-white rounded-3xl py-2">
              ...
              <div class="my-10">
                <NuxtLink to="/town-projects">
                  <span v-if="$route.path == '/town-projects'">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      fill="currentColor"
                      class="bi bi-bucket-fill mx-auto text-tm-green"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <span v-else class="text-3xl text-tm-black">
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      class="bi bi-bucket mx-auto"
                      viewBox="0 0 16 16"
                    >
                      <path d="M2.522 5H2a.5.5 0 0 0-.494.574l1.372 9.149A1.5 1.5 0 0 0 4.36 16h7.278a1.5 1.5 0 0 0 1.483-1.277l1.373-9.149A.5.5 0 0 0 14 5h-.522A5.5 5.5 0 0 0 2.522 5zm1.005 0a4.5 4.5 0 0 1 8.945 0H3.527zm9.892 1-1.286 8.574a.5.5 0 0 1-.494.426H4.36a.5.5 0 0 1-.494-.426L2.58 6h10.838z" />
                    </svg>
                  </span>
                  <h4 v-if="$route.path == '/town-projects'" class="text-lg font-medium leading-tight my-2 text-tm-green">
                    Projects
                  </h4>
              ...
              <div class="my-10">
                <NuxtLink to="/town-rooms">
                  <span v-if="$route.path == '/town-rooms'">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      fill="currentColor"
                      class="bi bi-people-fill mx-auto text-tm-green"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <h4 v-if="$route.path == '/town-rooms'" class="text-lg font-medium leading-tight my-2 text-tm-green">
                    Rooms
                  </h4>
                  <h4 v-else class="text-lg font-medium leading-tight my-2">
                    Rooms
              ...
              <div class="my-10">
                <NuxtLink to="/town-helplines">
                  <span v-if="$route.path == '/town-helplines'">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                      fill="currentColor"
                      class="bi bi-telephone-fill mx-auto text-tm-green"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <span v-else class="text-tm-black">
                    <svg
                      ...
                      height="24"
                      fill="currentColor"
                      class="bi bi-telephone mx-auto"
                      viewBox="0 0 16 16"
                    >
                      <path d="M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
                    </svg>
                  </span>
                  <h4 v-if="$route.path == '/town-helplines'" class="text-lg font-medium leading-tight my-2 text-tm-green">
                    Helplines
                  </h4>
                  <h4 v-else class="text-lg font-medium leading-tight my-2">
                    Helplines
      ...
      <div class="md:hidden block fixed inset-x-0 bottom-0 z-10 bg-tm-green p-2 m-2 rounded-3xl shadow">
        <div class="flex items-center justify-around text-white text-sm">
          ...
          <NuxtLink to="/town-projects">
            <span>
              <svg
                v-if="$route.path == '/town-projects'"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                fill="currentColor"
                class="bi bi-bucket-fill mx-auto text-white"
                viewBox="0 0 16 16"
              >
                <path d="M2.522 5H2a.5.5 0 0 0-.494.574l1.372 9.149A1.5 1.5 0 0 0 4.36 16h7.278a1.5 1.5 0 0 0 1.483-1.277l1.373-9.149A.5.5 0 0 0 14 5h-.522A5.5 5.5 0 0 0 2.522 5zm1.005 0a4.5 4.5 0 0 1 8.945 0H3.527z" />
              </svg>
              ...
              <span v-if="$route.path == '/town-projects'" class="font-bold">Projects</span>
          ...
          <NuxtLink to="/town-rooms">
            <span>
              <svg
                v-if="$route.path == '/town-rooms'"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                fill="currentColor"
                class="bi bi-people-fill mx-auto text-white"
                viewBox="0 0 16 16"
              >
                <path d="M7 14s-1 0-1-1 1-4 5-4 5 3 5 4-1 1-1 1H7zm4-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                <path fill-rule="evenodd" d="M5.216 14A2.238 2.238 0 0 1 5 13c0-1.355.68-2.75 1.936-3.72A6.325 6.325 0 0 0 5 9c-4 0-5 3-5 4s1 1 1 1h4.216z" />
              ...
              <span v-if="$route.path == '/town-rooms'" class="font-bold">Rooms</span>
          ...
          <NuxtLink to="/town-helplines">
            <span>
              <svg
                v-if="$route.path == '/town-helplines'"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                fill="currentColor"
                class="bi bi-telephone-fill mx-auto text-white"
                viewBox="0 0 16 16"
              >
                <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
              </svg>
              ...
              <span v-if="$route.path == '/town-helplines'" class="font-bold">Helplines</span>
              <span v-else>Helplines</span>
            </span>
          </NuxtLink>
        </div>
      </div>
