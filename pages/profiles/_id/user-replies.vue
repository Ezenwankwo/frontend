<template>
  <div class="grid grid-cols-10">
    <div class="col-span-10 lg:col-span-7 rounded-3xl lg:mr-8">
      <UserProfileMobile />
      <UserProfileNav />
      <div class="border-2 border-tm-gray bg-white rounded-3xl p-4 sm:p-6 my-2 sm:mt-4">
        <NuxtLink to="/post-reply">
      ...
      <div class="border-2 border-tm-gray bg-white rounded-3xl p-4 sm:p-6 mb-2 sm:mt-4">
        <div class="flex items-center justify-between">
          <i class="text-tm-green">reply to post</i>
          <span class="text-tm-black">
            <svg
