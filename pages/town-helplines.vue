  ...
  <div>
    ...
    <div class="grid grid-cols-10 rounded-3xl bg-white hidden md:flex">
      <div class="col-span-3 text-tm-black text-lg">
        ...
        <div class="flex justify-between p-4 sm:p-6 border-b-2 border-tm-gray">
      ...
      <div class="col-span-7 border-l-2 border-tm-gray p-4 sm:p-6">
        <div class="flex justify-between mb-4 md:mb-8">
          <input
            ...
            class="
              ...
              focus:outline-none
            "
            placeholder="Type to filter safety"
          >
          <button class="flex items-center font-medium bg-tm-green rounded-full text-white text-sm md:text-base px-6 py-3 border-transparent">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
        ...
        <div class="text-tm-black border border-tm-gray rounded-3xl mb-2 md:mb-4 p-2 md:p-4">
          ...
          <p class="mt-2 md:mt-4 text-sm md:text-base">
            This is simply dummy text of the printing and typesetting industry. Lorem Ipsum.
          </p>
        ...
        <div class="text-tm-black border border-tm-gray rounded-3xl p-2 md:p-4">
          <div class="flex justify-between">
            <div class="flex items-end">
              <img
                src="~/assets/profilepic.svg"
