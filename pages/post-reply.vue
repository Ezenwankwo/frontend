  ...
  <div class="grid grid-cols-10">
    <div class="col-span-10 lg:col-span-7 rounded-3xl lg:mr-8">
      ...
      <div class="border-2 border-tm-gray bg-white rounded-3xl p-4 sm:p-6 mt-1 sm:mt-2">
        ...
        <p class="text-tm-black my-2 font-normal text-base sm:text-lg">
        ...
        <div class="flex p-2 sm:p-4 border border-tm-gray rounded-3xl mt-4">
          ...
          <div class="ml-2 sm:ml-4 w-full">
            <textarea
              ...
              cols="30"
              rows="3"
              class="w-full text-tm-black text-sm sm:text-base border-l-2 border-tm-gray px-2 placeholder:italic focus:border-l-2 focus:border-tm-green focus:outline-none"
              placeholder="Reply"
            />
            <div class="flex items-center justify-between">
